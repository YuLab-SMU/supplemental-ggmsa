...
## Fig. \ref{fig:dms}: DMS plot

```{r dms, fig.height=5, fig.width=10, warning=FALSE, message=FALSE,fig.cap="\\label{fig:dms}DMS plot"}
...
## Fig. \ref{fig:pp_all}: All sites of protein-protein interactive plot

```{r pp_all, fig.height=5, fig.width=10, warning=FALSE, message=FALSE, fig.cap="\\label{fig:pp_all}All sites of protein-protein interactive plot"}
#read sequences
...
## Fig. \ref{fig:simp}: simplified p-p interactive plot

```{r simp, fig.height=5, fig.width=10, warning=FALSE, message=FALSE, fig.cap="\\label{fig:simp}All simplified p-p interactive plot"}
