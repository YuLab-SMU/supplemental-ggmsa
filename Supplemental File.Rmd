...
## Fig. \ref{fig:ancestral_sequences}: Displaying ancestral sequences for in Tree-MSA 

```{r ancestral_sequences, fig.height = 6, fig.width = 12, warning = FALSE,message=FALSE, fig.cap="\\label{fig:ancestral_sequences}The ancestral sequence is displayed by selecting the internal nodes in tree-MSA plot. And there are two display modes :(A) only showing the sequence corresponding to the selected ancestral node; (B) Displaying all ancestral sequences of subtree."}
...
## Fig. \ref{fig:simp}: simplified arc diagram of ACE2-RBD interaction

```{r simp, fig.height=5, fig.width=10, warning=FALSE, message=FALSE, fig.cap="\\label{fig:simp} simplified ACE2-RBD interaction arc plot.The arc plot only shows the residues at the sites of interaction."}
